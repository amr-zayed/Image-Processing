...
if __name__ == "__main__":
    ...
    """self.file_menu = QtWidgets.QMenu('Tasks', self)
        self.file_menu.addAction('Task 1', self.Task1, QtCore.Qt.CTRL + QtCore.Qt.Key_1)
        self.file_menu.addAction('Task 2', self.Task2, QtCore.Qt.CTRL + QtCore.Qt.Key_2)
